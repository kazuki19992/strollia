...
export function createStyles(theme: AppTheme) {
  ...
  return StyleSheet.create({
    ...
    stepSliderProgress: {
      backgroundColor: theme.name === 'dark' ? '#6b6b6b' : '#172b63',
      borderRadius: 999,
      height: 4,
    },
    stepSliderThumb: {
    ...
    stepSliderTick: {
      backgroundColor: theme.name === 'dark' ? '#5a5a5a' : '#d4d4d4',
      borderRadius: 999,
      bottom: -14,
      height: 8,
      marginLeft: -4,
